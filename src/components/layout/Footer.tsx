        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm">
              Digital Marketing Specialist for Vacation Rentals
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              <li>
                <a href="mailto:newsitebycaro@gmail.com" className="hover:text-primary-500 transition-colors">
                  newsitebycaro@gmail.com
                </a>
              </li>
              <li>
                <a href="https://wa.me/34611200787" className="hover:text-primary-500 transition-colors">
                  +34 611 200 787
                </a>
              </li>
            </ul>
